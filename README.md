...
> Create a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [Bernoulli][bernoulli] distribution.
...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-bernoulli@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-bernoulli/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-bernoulli@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-bernoulli/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-bernoulli@umd/browser.js"></script>
```
...
#### randomStream( p\[, options] )

Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [Bernoulli][bernoulli] distribution with success probability `p`.
...
var stream = randomStream( 0.2, opts1 );
...
#### randomStream.factory( \[p, ]\[options] )

Returns a `function` for creating [readable streams][readable-stream] which generate pseudorandom numbers drawn from a [Bernoulli][bernoulli] distribution.
...
```javascript
var createStream = randomStream.factory( 0.2 );
...
var stream1 = createStream( 0.2 );
var stream2 = createStream( 0.2 );
// ...
```
...
#### randomStream.objectMode( p\[, options] )
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-bernoulli.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-bernoulli

[test-image]: https://github.com/stdlib-js/random-streams-bernoulli/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-streams-bernoulli/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-streams-bernoulli/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-streams-bernoulli?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-bernoulli.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-streams-bernoulli/main
...
[cli-section]: https://github.com/stdlib-js/random-streams-bernoulli#cli
[cli-url]: https://github.com/stdlib-js/random-streams-bernoulli/tree/cli
[@stdlib/random-streams-bernoulli]: https://github.com/stdlib-js/random-streams-bernoulli/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-bernoulli/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-bernoulli/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-bernoulli/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-bernoulli/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-bernoulli/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-bernoulli/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-bernoulli/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-bernoulli/main/LICENSE

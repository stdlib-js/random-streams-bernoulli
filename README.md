...
```bash
npm install @stdlib/random-streams-bernoulli
```
...
```bash
npm install -g @stdlib/random-streams-bernoulli-cli
```
...
```text
Usage: random-bernoulli [options] <p>
...
```bash
$ random-bernoulli 0.2 -n 10 --seed 1234
```
